...
class OptionController extends Controller
{
    ...
    public function saveUserOptions(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'registration_roles' => 'nullable|array',
            'registration_roles.*' => 'string',
        ]);
        ...
        Option::set('registration_roles', isset($validated['registration_roles']) ? json_encode($validated['registration_roles']) : json_encode([]));
