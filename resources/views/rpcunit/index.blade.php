                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            @can('create_packaging')
                                                <div class="flex justify-end space-x-3">
                                                    ...
                                                    <button 
                                                        type="button"
                                                        class="delete-rpc-unit text-red-600 hover:text-red-900"
                                                        data-id="{{ $unit->id }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-rpc-unit')) {
            e.preventDefault();
            const button = e.target.closest('.delete-rpc-unit');
            const id = button.getAttribute('data-id');
            const url = button.getAttribute('data-url');
            
            if (confirm('Are you sure you want to delete this RPC unit? This action cannot be undone.')) {
                // Add loading state
