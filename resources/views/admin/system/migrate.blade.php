...
<head>
    ...
    <title>System Migration - {{ option('project_name', config('app.name', '')) }}</title>
...
<body class="font-sans antialiased bg-gray-100">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div class="w-full sm:max-w-4xl mt-6 px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            <strong>Warning:</strong> This action will run database migrations. Make sure you have a
            ...
            <form method="POST" action="{{ route('admin.system.migrate.run') }}" x-data="{ createAdmin: false }"
                onsubmit="return confirm('Are you sure you want to run database migrations? This action cannot be undone.');">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="system_key" id="system_key" required value="{{ old('system_key') }}"
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="radio" name="migration_type" value="migrate" checked
                        ...
                        <label class="flex items-center">
                            <input type="radio" name="migration_type" value="refresh"
                                class="form-radio text-indigo-600">
                            <span class="ml-2">
                                <strong>Migrate Fresh</strong> - Drop all tables and re-run all migrations (⚠️
                                destructive)
                            </span>
                        </label>
                    </div>
                ...
                <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
                    <label class="flex items-center mb-3">
                        <input type="checkbox" name="create_admin" value="1" x-model="createAdmin"
