    ...
    <script>
        (function () {
            ...
            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', initProductSelectCreate);
            } else {
                initProductSelectCreate();
            }
            document.addEventListener('turbo:load', initProductSelectCreate);
        })();
    </script>
</x-app-layout>
